...
import 'package:taxi_driver/view/menu/add_money_view.dart';

import '../../core/constants/img_constants.dart';
...
class _WalletViewState extends State<WalletView> {
  ...
  List walletArr = [
    {
      "icon":"${ImageConstants.imagesPath}/wallet_add.png",
      "name":"Added to Wallet",
      "time":"1 Feb 2024  #123456",
      "price":"\$40",
    },
    {
      "icon":"${ImageConstants.imagesPath}/wallet_add.png",
    ...
    {
      "icon":"${ImageConstants.imagesPath}/trips_cut.png",
      "name":"Added to Wallet",
      "time":"1 Feb 2024  #123456",
      "price":"\$40",
    },
    {
      "icon":"${ImageConstants.imagesPath}/withdraw.png",
      "name":"Added to Wallet",
      "time":"1 Feb 2024  #123456",
      "price":"\$40",
    },
