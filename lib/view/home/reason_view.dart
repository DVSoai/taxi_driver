      ...
      body:Column(
        children: [
          Expanded(
            ...
            separatorBuilder: (context, index) => Divider(color: TColor.placeholder,indent: 80,),
            itemBuilder: (context, index){
              return ListTile(
                leading: IconButton(
                  ...
                  icon:Image.asset(
                    selectedIndex == index ? "assets/img/check_list.png" : "assets/img/uncheck_list.png",
                    width: 25,
                    height: 25,
                  ) ,
                ),
                title: Text(
                  ...
                  style: TextStyle(
                    color: selectedIndex == index ? TColor.primaryText : TColor.secondaryText,
                    fontSize: 16
                  ),
                ),
              );
          ...
          Padding(
            ...
            child: RoundButton(title: 'DONE', onPressed: (){context.pop();}),
          ),
